...
PERIOD = '2025-12-31'
QUEUE = Path('/root/aicode/runs/stock_research_batch/20260728_a_priority20_queue.json')
LOG = Path('/root/aicode/runs/stock_research_batch/20260728_a_priority20_filtered.jsonl')
...
append_jsonl(LOG, {
    ...
    'filter': 'A-share priority20, hard loss excluded, turnaround-watch last',
})
selected_count = 0
skipped_count = 0
for item in items:
